...
export let convertData = function (data) {
  let res = []
...
export let category = []
export let dottedBase = +new Date()
export let lineData = []
export let barData = []
...
export function makeMapData_world (rawData) {
  let mapData = []
  for (let i = 0; i < rawData.length; i++) {
    let geoCoord = geoCoordMap_world[rawData[i][0]]
    if (geoCoord) {
      mapData.push({
        name: rawData[i][0],
...
export function makeParallelAxis_world (schema) {
  let parallelAxis = []
